...
```javascript
import nlp from 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp@v0.3.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { expandAcronyms, expandContractions, lda, ordinalize, porterStemmer, sentencize, tokenize } from 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp@v0.3.1-deno/mod.js';
```
