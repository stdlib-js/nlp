...
```javascript
nlp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp@v0.3.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/nlp@v0.3.2-umd/browser.js"></script>
```
